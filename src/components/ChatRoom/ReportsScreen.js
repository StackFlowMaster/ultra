...
export default function Reports(props) {
  ...
  let report = (reoprt) => {
    ...
    props.sendReportHandler('report', props.id, props.guestId);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>Thank you for helping us keep our</Text>
      <Text style={styles.description}>Community safe.</Text>
      <TouchableOpacity
        style={styles.btn}
        onPress={() => report()}>
